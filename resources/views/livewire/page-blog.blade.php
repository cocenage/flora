...
<section class="bg-[#f0efed]">
        ...
        <h1 class="text-[30px] lg:text-[50px] mt-[16px] underline decoration-1 lg:decoration-3 underline-offset-8">Flora Блог - цветочная мудрость</h1>



        <p       data-aos="fade-up"
    data-aos-delay="200"  class="18px mt-[12px] text-center max-w-[600px]">Полезные советы, тренды флористики и вдохновение для ваших цветочных историй. Читайте, учитесь и создавайте красоту вместе с Flora!</p>


    </div>
  <div class="pb-[40px] px-[40px] lg:pb-[50px] lg:px-[250px]">
    <div class="">
