...
<div class="py-[40px] px-[40px] lg:py-[50px] lg:px-[250px] bg-[#f0efed]">
    <div class="">
        <div class="flex flex-col md:flex-row gap-[10px]">
            ...
            <div class="md:w-1/4 bg-white p-6   border border-gray-100">
            ...
            <div class="md:w-3/4">
                ...
                <div class="bg-white p-4   border border-gray-100 mb-[10px] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
 ...
 <a wire:navigate href="{{ route('single.products', $product->slug) }}">
            ...
            <div class="bg-white rounded-xl  border border-gray-100 p-8 text-center">
                ...
                <button wire:click="resetFilters"
                    class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md  text-white bg-[#70B7F9]  focus:outline-none focus:ring-2 focus:ring-offset-2 ">
                    Сбросить фильтры
                </button>
            </div>
            @endif
            ...
            <div class="mt-8 bg-white px-6 py-4 rounded-xl  border border-gray-100">
                {{ $products->links() }}
            </div>
            @endif
